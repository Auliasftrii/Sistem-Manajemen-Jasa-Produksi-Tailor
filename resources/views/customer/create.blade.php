            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <div id="measurements-container">
                        ...
                        @if(old('measurements'))
                            @foreach(old('measurements') as $key => $val)
                                <div class="row mb-2 measurement-row">
                                    <div class="col-5">
                                        <input type="text" class="form-control" name="measurement_keys[]" value="{{ $key }}" placeholder="Bagian (ex: Lingkar Dada)">
                                    </div>
                                    <div class="col-5">
                                        <input type="text" class="form-control" name="measurements[{{ $key }}]" value="{{ $val }}" placeholder="Nilai (ex: 90 cm)">
                                    </div>
                                    <div class="col-2">
